...
<div class="container custom-container">
        <div>
            ...
            <ul class="nav nav-tabs my-custom-tabs mb-5">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Project Note</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Assigned Solo Task</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Assigned Group Task</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Submitted Task</a>
                </li>
                <li class="nav-item">
