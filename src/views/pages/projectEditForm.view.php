        ...
        <div class="card-body p-5">
            ...
            <form method="POST" action=<?= BASE_URL . "/index.php?" . http_build_query(["page" => "editProject"]) ?> >
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control <?= ($errors["projectNameErr"] ?? "") ? 'is-invalid' : ''; ?>" id="projectName" placeholder="Enter project name" name="projectName" value="">
                ...
                <div class="mb-4">
                    ...
                    <textarea type="text" class="form-control <?= ($errors["projectDescriptionErr"] ?? "") ? 'is-invalid' : ''; ?>" id="projectDescription" placeholder="Enter project description" name="projectDescription" style="height: 7rem;"></textarea>
